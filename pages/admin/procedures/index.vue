          ...
          <tbody>
            <tr v-for="(item, index) in data?.procedures" class="hover divide-y">
              ...
              <td class="text-right flex items-center justify-center gap-2 ">
                <NuxtLink :to="`procedures/${item.slug}`" class="btn btn-outline border-sky-700 hover:border-none border-2 btn-sm text-sky-600 text-xs hover:bg-gradient-to-b hover:from-sky-900 hover:to-sky-400 hover:text-white">نمایش
                </NuxtLink>
                <NuxtLink :to="`procedures/edit/${item.id}`" class="btn btn-outline border-amber-700 hover:border-none border-2 btn-sm text-amber-600 text-xs hover:bg-gradient-to-b hover:from-amber-900 hover:to-amber-400 hover:text-white">ویرایش
                </NuxtLink>
